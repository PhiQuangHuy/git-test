    ...
    <ul class="border-none list-none">
      ...
      <li v-if="question.other">
        ...
        <input
          type="text"
          v-model="otherAnswer"
          class="ml-2 mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 inline-block w-[50%] p- dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
